...
atributos.add_argument('login', type=str, required=True, help='This field is required.')
atributos.add_argument('senha', type=str, required=True, help='This field is required.')
